...
-- held in a relational database management system (RDBMS), or for stream processing in a relational data 
-- stream management system (RDSMS).
-- Originally based upon relational algebra and tuple relational calculus, SQL consists of a data definition 
-- language, data manipulation language, and a data control language. The scope of SQL includes data insert, 
-- query, update and delete, schema creation and modification, and data access control. Although SQL is often 
...
-- used for selecting, inserting, deleting and updating data in a database. Performing read-only queries of data
-- is sometimes also considered a component of DML.
-- A popular data manipulation language is that of Structured Query Language (SQL), which is used to retrieve 
-- and manipulate data in a relational database.[1] Other forms of DML are those used by IMS/DLI, CODASYL 
-- databases, such as IDMS and others.

-- A data definition language or data description language (DDL) is a syntax similar to a computer programming 
...
-- features to the Structured Query Language (SQL) including transaction control, exception and error handling, 
-- row processing, and declared variables. Microsoft's SQL Server and Sybase's SQL server support T-SQL 
-- statements. 
...
-- 08. Write a SQL query to find the email addresses of each employee (by his first and last name). Consider
-- that the mail domain is telerik.com. Emails should look like “John.Doe@telerik.com". The produced column 
-- should be named "Full Email Addresses".
