...
namespace First_before_last
{
    ...
    class Tasks3_4_5
    {
        static void Main()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Students whose first name is is before last alphabetically");
            ...
            var ageResult = FindPeopleAtCertainAge(arrayOfStudents, 18, 24);
        ...
        private static IEnumerable<Student> FindPeopleAtCertainAge(Student[] students, int startAge, int endAge)
        {
            IEnumerable<Student> result =
                from student in students
